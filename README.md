# Server-Rotating Federated Learning for Non-IID Classification Tasks
...
The code demonstrates the implementation of the proposed SRFLM method on the MNIST dataset for a classification task under non-IID settings.
